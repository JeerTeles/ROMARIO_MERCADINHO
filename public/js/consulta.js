document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderClientsInSearchTable(clients) {
        ...
        clients.forEach((client) => {
            ...
            quantidadeCliente.textContent = client.quantidade;
            row.appendChild(quantidadeCliente);

            const divida = document.createElement('td');
            divida.textContent = client.divida;
            row.appendChild(divida);
